...
![anaconda 下载选择](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202303241219353.png)

### 安装环境

下载过程中使用默认，但有一个页面需要确认，如下图。

![anaconda选择页面](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202303241219803.png)
...
![安装显示界面](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202303241220350.png)
...
![安装决策树依赖包](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202303241221843.png)
...
![学习表](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202303241222952.png)
...
![决策树分析结果](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202303241223943.png)
