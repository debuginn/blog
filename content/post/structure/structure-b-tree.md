...
![节点](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202304142214771.png)
...
![树的深度](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202304142215388.png)
...
![插入节点](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202304142216126.png)
...
![插入节点30](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202304142216107.png)
...
![插入节点 26](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202304142217563.png)
...
![插入节点 85](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202304142218005.png)
...
![插入节点 7](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202304142218242.png)

通过上边的例子，可以总结出一下结论：在构建 B-树的过程中，假设 p 结点中已经有 m-1 个关键字，当再插入一个关键字之后，此结点分裂为两个结点，如下图所示：

![插入节点 b-](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202304142219494.png)
...
![删除节点 50](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202304142220726.png)
...
![删除节点 53](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202304142221058.png)
...
![删除节点 37](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202304142221785.png)

上图删除结点 37后的效果图。

由于结点 b 中一个关键字也没有，所以破坏了B-树的结构，继续整合。在删除结点 b 的同时，由于 b 中仅剩指向结点 c 的指针，所以连同其双亲结点中的 45 一同合并到其兄弟结点 e 中，最终的B-树为：

![删除节点后](https://cdn.jsdelivr.net/gh/debuginn/image@main/img/202304142222060.png)
